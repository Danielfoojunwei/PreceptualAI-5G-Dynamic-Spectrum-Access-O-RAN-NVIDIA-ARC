...
| 11/11 integrity probes detected or blocked, 0 bypassed (3 replay captured 5GAD traffic byte for byte) | `benchmarks/results/integrity_attack_suite.json` | same verifier |
