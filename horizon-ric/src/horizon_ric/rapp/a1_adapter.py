...
class A1Adapter:
    ...
    def __init__(self, config: A1AdapterConfig | None = None):
        ...
        elif self.cfg.dns_cache_ttl_s > 0:
            from horizon_ric.runtime.dns_cache import build_caching_async_client

            self._client = build_caching_async_client(
                base_url=self.cfg.near_rt_ric_base_url,
                ttl_seconds=self.cfg.dns_cache_ttl_s,
