...
class TestCfCCell:
    ...
    def test_exact_variant(self):
        from spectrai.core.ltc_cell_cfc import CfCCellExact
...
class TestMambaEncoder:
    def test_ssm_block(self):
        from spectrai.core.mamba_encoder import SelectiveSSMBlock
...
class TestGNNEncoder:
    def test_gat_layer(self):
        from spectrai.core.gnn_encoder import GraphAttentionLayer
...
class TestKANActor:
    def test_kan_linear(self):
        from spectrai.core.kan_actor import KANLinear
...
class TestSmoothActor:
    def test_smode_neuron(self):
        from spectrai.core.smooth_actor import SmODENeuron
    ...
    def test_smooth_hybrid(self):
        from spectrai.core.smooth_actor import SmoothHybridActor
...
class TestFNOSurrogate:
    def test_spectral_conv(self):
        from spectrai.core.fno_surrogate import SpectralConv1d
...
class TestDAppEngine:
    def test_lightweight_cell(self):
        from spectrai.xapp.dapp_engine import LightweightLTCCell
...
class TestRAppTrainer:
    def test_model_catalog(self):
        from spectrai.xapp.rapp_trainer import ModelCatalog, ModelVersion
    ...
    def test_performance_monitor(self):
        from spectrai.xapp.rapp_trainer import PerformanceMonitor
    ...
    def test_a1_policy_generation(self):
        from spectrai.xapp.rapp_trainer import RAppTrainingService, ModelVersion
    ...
    def test_e2_prb_blanking(self):
        from spectrai.xapp.rapp_trainer import RAppTrainingService
        svc = RAppTrainingService(device=torch.device("cpu"))
...
class TestAerialAdapter:
    ...
    def test_xapp_descriptor(self):
        ...
        assert desc["xapp_name"] == "spectrai-dsa"
...
class TestNTNInterference:
    def test_ntn_step(self):
        from spectrai.env.fr3_propagation import NTNInterferenceModel
        device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
