"""
Federated Learning Flywheel Demo for PreceptualAI.
...
from preceptualai.federated.aggregator import HybridFederatedAggregator
...
def make_env(
    ...
    if trace_files is not None and len(trace_files) > 0:
        ...
        tmp_dir = tempfile.mkdtemp(prefix="preceptualai_fl_")
...
def plot_results(
    ...
    summary = (
        "PreceptualAI Federated Learning — Results Summary\n"
        "=" * 46 + "\n\n"
    ...
    fig.suptitle("PreceptualAI Federated Learning: Hybrid LTC-Aware Aggregation",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="PreceptualAI Federated Learning Flywheel Demo",
    ...
    print("=" * 60)
    print("  PreceptualAI Federated Learning — Flywheel Demo")
    print("=" * 60)
